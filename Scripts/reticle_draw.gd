...
func set_crosshair_radius(new_radius: float):
	radius = new_radius
	update_crosshair()

func set_crosshair_thickness(new_thickness : float):
	thickness = new_thickness
	update_crosshair()

func set_crosshair_color(new_color : Color):
	color = new_color
	update_crosshair()
	
func set_crosshair_angle(new_angle : float):
	gap_angle = new_angle
	update_crosshair()
	
func set_crosshair_segments(new_segments : int):
